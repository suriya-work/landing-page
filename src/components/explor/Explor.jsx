...
const Explor = () => {
    return (
        <div className='sm:container sm:mx-auto  rounded-lg grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-1  bg-pink'>
            <div className=''>
            ...
            <div className='container-input ps-20 text-center pt-9 pb-12'>
